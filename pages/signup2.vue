                    ...
                    <ValidationObserver v-slot="{ invalid }">
                        ...
                        <div class="form-group">
                            ...
                            <ValidationProvider
                                ...
                                name="address"
                                rules="required">
                            <input type="text" class="form-control" @keydown.space.prevent 
                            v-model="signup.address" required>
                            <span class="input-invalid-message">
                                {{ errors[0] }}
                            </span>
                            </ValidationProvider>
                        ...
                        <div class="form-group">
                            ...
                            <ValidationProvider
                                ...
                                rules="required">
                            <input type="text" class="form-control" @keydown.space.prevent 
                            v-model="signup.phone_number" required>
                            <span class="input-invalid-message">
                                {{ errors[0] }}
                            </span>
                            </ValidationProvider>
                       ...
                       <!-- <div>
                        ...
                        <button type="submit" :disabled="invalid" class="login">Save & continue</button>
